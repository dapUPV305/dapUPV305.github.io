...
function createScud(alien, objectName) {
    ...
    switch (objectName) {
        ...
        case 'alien1':
            var scudMaterial = new THREE.MeshLambertMaterial({ color: 'white', shading: THREE.FlatShading });
...
function createAlien(position, distance, objectName) {
    ...
    switch (objectName) {
        ...
        case 'alien1':
            alienMaterial = new THREE.MeshLambertMaterial({ color: 'white' });
        ...
        case 'alien2':
            var alienMaterial = new THREE.MeshLambertMaterial({ color: 'white' });
