...
function init() {
    ...
    direccional.position.set(-40,40,-40);
...
function loadScene(){
    ...
    base = new THREE.Mesh( geometry_base, brazo_robot );
    ...
    eje = new THREE.Mesh( geometry_eje, brazo_robot ); 
    ...
    const esparrago = new THREE.Mesh( geometry_esparrago, brazo_robot );
    ...
    rotula = new THREE.Mesh( geometry_rotula, brazo_robot);
    ...
    const disco = new THREE.Mesh( geometry_disco, brazo_robot );
    ...
    mano = new THREE.Mesh( geometry_mano, brazo_robot );
